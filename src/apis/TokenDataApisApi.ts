...
export interface TokenDataApisApiInterface {
   ...
   */
  createTokenDataRaw(
    requestParameters: CreateTokenDataRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ResponsesResponseTokenData>>;
  ...
  createTokenData(
    requestParameters: CreateTokenDataRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ResponsesResponseTokenData>;
   ...
   * @memberof TokenDataApisApiInterface
   */
  getTokenDataForServerRaw(
    requestParameters: GetTokenDataForServerRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ResponsesResponseITokenData>>;
  ...
  getTokenDataForServer(
    requestParameters: GetTokenDataForServerRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ResponsesResponseITokenData>;
   ...
   */
  listTokenDataRaw(
    requestParameters: ListTokenDataRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ResponsesResponseIListTokenData>>;
  ...
  listTokenData(
    requestParameters: ListTokenDataRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ResponsesResponseIListTokenData>;
   ...
   */
  updateTokenDataRaw(
    requestParameters: UpdateTokenDataRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ResponsesResponseTokenData>>;
...
export class TokenDataApisApi extends runtime.BaseAPI implements TokenDataApisApiInterface {
  ...
  async createTokenDataRaw(
    ...
    if (requestParameters.xApiKey === null || requestParameters.xApiKey === undefined) {
      throw new runtime.RequiredError(
        'xApiKey',
        'Required parameter requestParameters.xApiKey was null or undefined when calling createTokenData.',
      );
    }
    ...
    if (requestParameters.iTokenData === null || requestParameters.iTokenData === undefined) {
      throw new runtime.RequiredError(
        'iTokenData',
        'Required parameter requestParameters.iTokenData was null or undefined when calling createTokenData.',
      );
    }
   ...
   * Gets the token data (minting data and metadata) saved. You can use this to update and show the data.
   */
  async getTokenDataForServerRaw(
    requestParameters: GetTokenDataForServerRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ResponsesResponseITokenData>> {
    if (requestParameters.tokenDataId === null || requestParameters.tokenDataId === undefined) {
      throw new runtime.RequiredError(
        'tokenDataId',
        'Required parameter requestParameters.tokenDataId was null or undefined when calling getTokenDataForServer.',
      );
    }
    ...
    if (requestParameters.xApiKey === null || requestParameters.xApiKey === undefined) {
      throw new runtime.RequiredError(
        'xApiKey',
        'Required parameter requestParameters.xApiKey was null or undefined when calling getTokenDataForServer.',
      );
    }
  ...
  async listTokenDataRaw(
    ...
    if (requestParameters.xApiKey === null || requestParameters.xApiKey === undefined) {
      throw new runtime.RequiredError(
        'xApiKey',
        'Required parameter requestParameters.xApiKey was null or undefined when calling listTokenData.',
      );
    }
  ...
  async updateTokenDataRaw(
    ...
    if (requestParameters.xApiKey === null || requestParameters.xApiKey === undefined) {
      throw new runtime.RequiredError(
        'xApiKey',
        'Required parameter requestParameters.xApiKey was null or undefined when calling updateTokenData.',
      );
    }
    ...
    if (requestParameters.iUpdateTokenData === null || requestParameters.iUpdateTokenData === undefined) {
      throw new runtime.RequiredError(
        'iUpdateTokenData',
        'Required parameter requestParameters.iUpdateTokenData was null or undefined when calling updateTokenData.',
      );
    }
