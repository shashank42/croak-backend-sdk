...
export interface WalletBalanceAPIsApiInterface {
   ...
   */
  getTestErc20BalanceRaw(
    requestParameters: GetTestErc20BalanceRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ResponsesWalletBalanceArray>>;
  ...
  getTestErc20Balance(
    requestParameters: GetTestErc20BalanceRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ResponsesWalletBalanceArray>;
   ...
   * @memberof WalletBalanceAPIsApiInterface
   */
  listNFTsForWalletForClientRaw(
    requestParameters: ListNFTsForWalletForClientRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ResponsesResponseIListUsersTokens>>;
  ...
  listNFTsForWalletForClient(
    requestParameters: ListNFTsForWalletForClientRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ResponsesResponseIListUsersTokens>;
   ...
   * @memberof WalletBalanceAPIsApiInterface
   */
  listNFTsForWalletForServerRaw(
    requestParameters: ListNFTsForWalletForServerRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ResponsesResponseIListUsersTokens>>;
...
export class WalletBalanceAPIsApi extends runtime.BaseAPI implements WalletBalanceAPIsApiInterface {
  ...
  async getTestErc20BalanceRaw(
    ...
    if (requestParameters.walletId === null || requestParameters.walletId === undefined) {
      throw new runtime.RequiredError(
        'walletId',
        'Required parameter requestParameters.walletId was null or undefined when calling getTestErc20Balance.',
      );
    }
    ...
    if (requestParameters.xApiKey === null || requestParameters.xApiKey === undefined) {
      throw new runtime.RequiredError(
        'xApiKey',
        'Required parameter requestParameters.xApiKey was null or undefined when calling getTestErc20Balance.',
      );
    }
  ...
  async getWalletBalanceRaw(
    ...
    if (requestParameters.walletId === null || requestParameters.walletId === undefined) {
      throw new runtime.RequiredError(
        'walletId',
        'Required parameter requestParameters.walletId was null or undefined when calling getWalletBalance.',
      );
    }
    ...
    if (requestParameters.xApiKey === null || requestParameters.xApiKey === undefined) {
      throw new runtime.RequiredError(
        'xApiKey',
        'Required parameter requestParameters.xApiKey was null or undefined when calling getWalletBalance.',
      );
    }
   ...
   * This function returns a list of NFTs for a given wallet
   */
  async listNFTsForWalletForClientRaw(
    requestParameters: ListNFTsForWalletForClientRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ResponsesResponseIListUsersTokens>> {
    if (requestParameters.accessToken === null || requestParameters.accessToken === undefined) {
      throw new runtime.RequiredError(
        'accessToken',
        'Required parameter requestParameters.accessToken was null or undefined when calling listNFTsForWalletForClient.',
      );
    }
   ...
   * This function returns a list of NFTs for a given wallet
   */
  async listNFTsForWalletForClient(
    requestParameters: ListNFTsForWalletForClientRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ResponsesResponseIListUsersTokens> {
   ...
   * This function returns a list of all the NFTs that a user owns
   */
  async listNFTsForWalletForServerRaw(
    requestParameters: ListNFTsForWalletForServerRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ResponsesResponseIListUsersTokens>> {
    if (requestParameters.xApiKey === null || requestParameters.xApiKey === undefined) {
      throw new runtime.RequiredError(
        'xApiKey',
        'Required parameter requestParameters.xApiKey was null or undefined when calling listNFTsForWalletForServer.',
      );
    }
   ...
   * This function returns a list of all the NFTs that a user owns
   */
  async listNFTsForWalletForServer(
    requestParameters: ListNFTsForWalletForServerRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ResponsesResponseIListUsersTokens> {
