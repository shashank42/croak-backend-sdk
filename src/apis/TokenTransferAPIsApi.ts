...
export interface TokenTransferAPIsApiInterface {
   ...
   */
  createTransferOrderRaw(
    requestParameters: CreateTransferOrderRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ResponsesICreateTokenTransferResp>>;
  ...
  createTransferOrder(
    requestParameters: CreateTransferOrderRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ResponsesICreateTokenTransferResp>;
   ...
   * @memberof TokenTransferAPIsApiInterface
   */
  submitTransferOrderRaw(
    requestParameters: SubmitTransferOrderRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ResponsesISubmitTokenTransferResp>>;
  ...
  submitTransferOrder(
    requestParameters: SubmitTransferOrderRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ResponsesISubmitTokenTransferResp>;
}
...
export class TokenTransferAPIsApi extends runtime.BaseAPI implements TokenTransferAPIsApiInterface {
  ...
  async createTransferOrderRaw(
    ...
    if (requestParameters.accessToken === null || requestParameters.accessToken === undefined) {
      throw new runtime.RequiredError(
        'accessToken',
        'Required parameter requestParameters.accessToken was null or undefined when calling createTransferOrder.',
      );
    }
    ...
    if (requestParameters.iCreateTokenTransfer === null || requestParameters.iCreateTokenTransfer === undefined) {
      throw new runtime.RequiredError(
        'iCreateTokenTransfer',
        'Required parameter requestParameters.iCreateTokenTransfer was null or undefined when calling createTransferOrder.',
      );
    }
  ...
  async submitTransferOrderRaw(
    ...
    if (requestParameters.accessToken === null || requestParameters.accessToken === undefined) {
      throw new runtime.RequiredError(
        'accessToken',
        'Required parameter requestParameters.accessToken was null or undefined when calling submitTransferOrder.',
      );
    }

    if (
      requestParameters.iSubmitTokenTransferString === null ||
      requestParameters.iSubmitTokenTransferString === undefined
    ) {
      throw new runtime.RequiredError(
        'iSubmitTokenTransferString',
        'Required parameter requestParameters.iSubmitTokenTransferString was null or undefined when calling submitTransferOrder.',
      );
    }
