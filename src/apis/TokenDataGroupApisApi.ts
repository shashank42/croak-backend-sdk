...
export interface TokenDataGroupApisApiInterface {
   ...
   */
  createTokenGroupDataRaw(
    requestParameters: CreateTokenGroupDataRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ResponsesTokenGroupData>>;
  ...
  createTokenGroupData(
    requestParameters: CreateTokenGroupDataRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ResponsesTokenGroupData>;
   ...
   * @memberof TokenDataGroupApisApiInterface
   */
  getTokenGroupDataRaw(
    requestParameters: GetTokenGroupDataRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ResponsesIGetTokenGroupDataResp>>;
  ...
  getTokenGroupData(
    requestParameters: GetTokenGroupDataRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ResponsesIGetTokenGroupDataResp>;
   ...
   * @memberof TokenDataGroupApisApiInterface
   */
  listTokenGroupDataRaw(
    requestParameters: ListTokenGroupDataRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ResponsesIListTokenGroupDataResp>>;
  ...
  listTokenGroupData(
    requestParameters: ListTokenGroupDataRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ResponsesIListTokenGroupDataResp>;
   ...
   * @memberof TokenDataGroupApisApiInterface
   */
  updateTokenGroupDataRaw(
    requestParameters: UpdateTokenGroupDataRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ResponsesTokenGroupData>>;
...
export class TokenDataGroupApisApi extends runtime.BaseAPI implements TokenDataGroupApisApiInterface {
  ...
  async createTokenGroupDataRaw(
    ...
    if (requestParameters.xApiKey === null || requestParameters.xApiKey === undefined) {
      throw new runtime.RequiredError(
        'xApiKey',
        'Required parameter requestParameters.xApiKey was null or undefined when calling createTokenGroupData.',
      );
    }
    ...
    if (requestParameters.iTokenGroupData === null || requestParameters.iTokenGroupData === undefined) {
      throw new runtime.RequiredError(
        'iTokenGroupData',
        'Required parameter requestParameters.iTokenGroupData was null or undefined when calling createTokenGroupData.',
      );
    }
  ...
  async getTokenGroupDataRaw(
    ...
    if (requestParameters.tokenGroupDataId === null || requestParameters.tokenGroupDataId === undefined) {
      throw new runtime.RequiredError(
        'tokenGroupDataId',
        'Required parameter requestParameters.tokenGroupDataId was null or undefined when calling getTokenGroupData.',
      );
    }
    ...
    if (requestParameters.xApiKey === null || requestParameters.xApiKey === undefined) {
      throw new runtime.RequiredError(
        'xApiKey',
        'Required parameter requestParameters.xApiKey was null or undefined when calling getTokenGroupData.',
      );
    }
  ...
  async listTokenGroupDataRaw(
    ...
    if (requestParameters.xApiKey === null || requestParameters.xApiKey === undefined) {
      throw new runtime.RequiredError(
        'xApiKey',
        'Required parameter requestParameters.xApiKey was null or undefined when calling listTokenGroupData.',
      );
    }
  ...
  async updateTokenGroupDataRaw(
    ...
    if (requestParameters.xApiKey === null || requestParameters.xApiKey === undefined) {
      throw new runtime.RequiredError(
        'xApiKey',
        'Required parameter requestParameters.xApiKey was null or undefined when calling updateTokenGroupData.',
      );
    }
    ...
    if (requestParameters.iUpdateTokenGroupData === null || requestParameters.iUpdateTokenGroupData === undefined) {
      throw new runtime.RequiredError(
        'iUpdateTokenGroupData',
        'Required parameter requestParameters.iUpdateTokenGroupData was null or undefined when calling updateTokenGroupData.',
      );
    }
